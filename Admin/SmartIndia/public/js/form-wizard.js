var FormWizard = function() {
	...
	var wizardForm = $('#form');
	var initWizard = function(wizDiv, wizForm) {
		if(typeof(wizDiv) != undefined  && wizDiv != null )
			wizardContent = wizDiv;
			
		if(typeof(wizForm) != undefined && wizForm != null )
			wizardForm = wizForm;
	...
	return {
		init : function(wizDiv, wizForm) {
			
			initWizard(wizDiv, wizForm);
		}
	};
}();
