...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="page-header">
                    <h1 style="float:left">Team Feedback list</h1>
        ...
        <table class="table table-bordered" id="teamfeedback-table">
            <thead>
            <tr>
                <th>Sl No</th>
                <th>Team Name</th>
        ...
        <script>
         $('.errorHandler').delay(3200).fadeOut(300);
            ...
            $(document).ready(function(){
              ...
              table =  $('#teamfeedback-table').DataTable( {
                ajax: "{{asset('teamfeedback/data')}}",
                columns: [
                    { data: "id"},
                    { data: "name"},
                    { data: "title"},                   
              ...
              table.on('order.dt', function() {
                ...
                $('#teamfeedback-table').on('click', 'button.editor_remove', function (e) {
                    ...
                    if (result) {
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                table.ajax.reload();
                                if(data ==1){
                                	 var message = "Team Feedback deleted successfully";
                                	 $('#msg').show();
